...
<html>
    ...
    <?php
                if(@$_SESSION['siswa 11A']){
                    $user = @$_SESSION['siswa 11A'];
                }else if(@$_SESSION['guru'])
                $user = @$_SESSION['guru'];
            }
            
            $ambilData = mysqli_query($koneksi,"SELECT * FROM data_siswa_11a WHERE nis ='$user'");
            $data = mysqli_fetch_array($ambilData);
                ?>
        
        <div class="header">Tambah Data Siswa</div>
        <div class="info">
        <head>
            <meta charset="utf-8">
            ...
            <body>
               <form action="" method ="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="kelas" value="11B" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <?php 
                     if(isset($_POST['proses']))
                     {
                         ...
                         $alamat= $_POST['alamat'];
                         $tlp= $_POST['tlp'];
                         $tambah= mysqli_query($koneksi,"UPDATE  data_siswa_11a SET nama='$nama',kelas='$kelas',tempat='$tempat',tanggal='$tanggal',alamat='$alamat',tlp='$tlp',agama='$agama',jenis='$jenis' WHERE nis='$nis'");
                         if($tambah){
                             ?>

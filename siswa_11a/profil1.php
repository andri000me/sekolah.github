<?php
    ...
    if(@$_SESSION['admin']||@$_SESSION['guru']||@$_SESSION['siswa 11A']){
?> 
...
<html>
    ...
    <div class="wrapper">
        ...
        <div class="main_content">
                ...
                $ambilData = mysqli_query($koneksi,"SELECT * FROM tb_login_11a WHERE kode_user ='$user'");
        ...
        <head>
            ...
            <body>
               <form action="" method ="post">
                    ...
                    mysqli_query($koneksi,"INSERT INTO data_siswa_11a SET
                    nis= '$_POST[nis]',
                    nama= '$_POST[nama]',
                    kelas= '$_POST[kelas]',
                    tempat= '$_POST[tempat]',

...
<html>
    ...
    <nav class="sidebar">
        ...
        <div class="header">Laporan Data Siswa Kelas 11A</div>
        <div class="info">
        <head>
            <meta charset="utf-8">
        ...
        <br>
            ...
            <?php
                ...
                if(isset($_POST['submit'])){
                    $cari=$_POST['cari'];
                    $query = mysqli_query($koneksi,"SELECT * FROM data_siswa_11a WHERE nama LIKE '$cari%'");
                }else{
                    $query= mysqli_query($koneksi,"SELECT * FROM data_siswa_11a");
                }
            ...
            ?>
                <tr>
                    ...
                    <td align="center" width="80"><a href="edit-siswa_11a.php?id=<?php echo $data['nis']; ?> ">
                    <button type="button" class="btn btn-warning">Edit</button>
                    <td align="center" width="80"><a href="hapus-siswa_11a.php?id=<?php echo $data['nis']; ?>">

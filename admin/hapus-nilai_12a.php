<?php
      ...
      $id = $_GET['id'];
      $ambilData = mysqli_query($koneksi,"DELETE FROM nilai_12a WHERE nis='$id'");
      echo "<meta http-equiv='refresh' url=http://localhost/web-penjualan/data_customer.php>";
?>
...
<html>
    ...
    <div class="wrapper">
        ...
        <div class="header"><b>Laporan Nilai Nilai Siswa Kelas 12A<b></div>
        <div class="info">
        <head>
            <meta charset="utf-8">
        ...
        <br>
            <body>
            <a href="cetak_nilai_12a.php"><button type="button" class="btn btn-outline-success btn-lg btn-block">Cetak</button>
            <br>
            ...
            <?php
                ...
                if(isset($_POST['submit'])){
                    $cari=$_POST['cari'];
                    $query = mysqli_query($koneksi,"SELECT * FROM nilai_11a WHERE nama LIKE '$cari%'");
                }else{
                    $query= mysqli_query($koneksi,"SELECT * FROM nilai_11a ORDER BY total DESC ");
                }
            ...
            ?>
                <tr>
                    ...
                    <td align="center" width="80"><?php echo $data['fisika'];?></td>
                    <td align="center" width="80"><?php echo $data['kimia'];?></td>
                    <td align="center" width="80"><?php echo $data['biologi'];?></td>
                    ...
                    <td align="center" width="80"><a href="edit-nilai_12a.php?id=<?php echo $data['nis']; ?> ">
                    <button type="button" class="btn btn-warning">Edit</button>
                    <td align="center" width="80"><a href="hapus-nilai_12a.php?id=<?php echo $data['nis']; ?> ">

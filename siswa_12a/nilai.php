...
<html>
    ...
    <nav class="sidebar">
        ...
        <div class="header">Laporan Nilai Siswa Kelas 12A</div>
        <div class="info">
        <head>
            <meta charset="utf-8">
        ...
        <?php
                ...
                if(isset($_POST['submit'])){
                    $cari=$_POST['cari'];
                    $query = mysqli_query($koneksi,"SELECT * FROM nilai_12a WHERE nama LIKE '$cari%'");
                }else{
                    $query= mysqli_query($koneksi,"SELECT * FROM nilai_12a ORDER BY total DESC ");
                }
